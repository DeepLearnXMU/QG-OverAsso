...
if __name__ == '__main__':
    lang = 'en'
    data_path = '../saved_data/data_woi/test.json'
    predict_path = '../saved_data/YOUR_MODEL_NAME/generated_predictions.txt'

    # lang = 'zh'
    # data_path = '../saved_data/data_dusinc/test_single_ref.json'
    # predict_path = '../saved_data/YOUR_MODEL_NAME/generated_predictions.txt'
    ...
    print(f'summation {round(b1_score, 2)+round(b2_score, 2)+round(f1_score, 2)}')