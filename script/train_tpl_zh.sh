...
DATA_DIR='../saved_data/data_tpl_gen_4mz'
OUTPUT_DIR='../saved_data'
STOPWORDS_PATH='examples/pytorch/wizard_of_internet/cn_stopwords.txt'

cd transformers
CUDA_VISIBLE_DEVICES=2 python examples/pytorch/wizard_of_internet/run_zh.py \
    ...
    --source_prefix "" \
    --output_dir "$OUTPUT_DIR/mengzi-t5-base-tpl-gen" \
...
#    --test_file "$DATA_DIR/dev.json" \
#    --source_prefix "" \
#    --output_dir "$OUTPUT_DIR/mengzi-t5-base-weight-05" \
#    --per_device_train_batch_size=16 \
#    --per_device_eval_batch_size=16 \
#    --gradient_accumulation_steps 4 \
#    --predict_with_generate \
