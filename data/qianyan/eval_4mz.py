...
if __name__ == '__main__':
    ...
    for step in range(1000, 9000, 1000):
        ...
        predict_path = f'../../saved_data/mengzi-t5-base-ext-gen/checkpoint-{step}/generated_predictions.txt'
        # predict_path = f'../../saved_data/mengzi-t5-base-weight-v2/generated_predictions.txt'
