...
def parse(input_dict: dict):
    ...
    num_beams = 4 # data_args.num_beams if data_args.num_beams is not None else training_args.generation_num_beams
...
def main():
    ...
    tokenizer = AutoTokenizer.from_pretrained(
        model_args.tokenizer_name if model_args.tokenizer_name else model_args.model_name_or_path, # strange error
        cache_dir=model_args.cache_dir,
